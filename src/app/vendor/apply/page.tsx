...
import { vendorApplyAction } from "@/lib/actions/vendor";
  ...
  return (
    <div className="mx-auto max-w-xl px-6 py-16">
      ...
      <p className="text-brand-gray text-sm mb-8">
        Join our verified vendor network. Our team reviews every application
      ...
      <form action={vendorApplyAction} className="flex flex-col gap-4">
